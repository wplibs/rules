...
use WPLibs\Rules\Context;
use WPLibs\Rules\Variable;
use WPLibs\Rules\Variable_Property;
...
class Rulesest extends \WP_UnitTestCase {
	...
	public function testDynamicCallOpeators() {
		...
		// Compare operators.
		$this->assertInstanceOf( 'WPLibs\Rules\Operator\Equal', $varA->equal( 0 ) );
		...
		$this->assertInstanceOf( 'WPLibs\Rules\Operator\Not_Equal', $varA->not_equal( 0 ) );
		...
		$this->assertInstanceOf( 'WPLibs\Rules\Operator\Greater_Than', $varA->greater_than( 0 ) );
		$this->assertTrue( $varA->greater_than( 0 )->evaluate( $context ) );
		$this->assertFalse( $varA->greater_than( 2 )->evaluate( $context ) );

		$this->assertInstanceOf( 'WPLibs\Rules\Operator\Greater_Than_Or_Equal', $varA->greater_than_or_equal( 0 ) );
		...
		$this->assertInstanceOf( 'WPLibs\Rules\Operator\Less_Than', $varA->less_than( 0 ) );
		$this->assertTrue( $varA->less_than( 2 )->evaluate( $context ) );
		$this->assertFalse( $varA->less_than( 0 )->evaluate( $context ) );

		$this->assertInstanceOf( 'WPLibs\Rules\Operator\Less_Than_Or_Equal', $varA->less_than_or_equal( 0 ) );
